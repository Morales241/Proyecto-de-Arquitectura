...
public class TableroView extends javax.swing.JFrame implements IComponente {
    ...
    public TableroView(TableroModel tableroModel) {
        ...
        traerFichasAlPanel(tableroModel.getFichas());

    }

    private void traerFichasAlPanel(List<FichaDto> fichas) {
        for (FichaDto ficha : fichas) {
            dibujarFicha(ficha);
        }
    }

    private void dibujarFicha(FichaDto ficha) {
