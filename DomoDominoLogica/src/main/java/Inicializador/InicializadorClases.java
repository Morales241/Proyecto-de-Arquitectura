...
/**
 * Clase que Inicializa todas las clases Mvc y clase mediador. Encapsula los MVC y los pone en el mediador
 *
 *
...
public class InicializadorClases {
    ...
    public void InicializarClases(Mediador mediador) {
        ...
        /*si se crean mas pantallas ponganlas aqui arriba y registrenlas abajo mediador*/
