...
public class Arreglo {
      ...
      public boolean colocarFichaExtremoDerecho(Ficha ficha, String direccion) {
            ...
            if (ficha.esMula()) {
                  switch (direccion) {
                        case "Derecha":
                              colocarFichaExtremoDerechoMulaHaciaDerecha(ficha);
                              break;
                        case "Abajo":
                              colocarFichaExtremoDerechoMulaHaciaAbajo(ficha);
                              break;
                        case "Izquierda":
                              colocarFichaExtremoDerechoMulaHaciaIzquierda(ficha);
                              break;
                        case "Arriba":
                              colocarFichaExtremoDerechoMulaHaciaArriba(ficha);
                              break;
                  }
            }
            ...
            if (ficha.getLado1() == extremoDerecha) {
                  switch (direccion) {
                        case "Derecha":
                              colocarFichaExtremoDerechoLado1HaciaDerecha(ficha);
                              break;
                        case "Abajo":
                              colocarFichaExtremoDerechoLado1HaciaAbajo(ficha);
                              break;
                        case "Izquierda":
                              colocarFichaExtremoDerechoLado1HaciaIzquierda(ficha);
                              break;
                        case "Arriba":
                              colocarFichaExtremoDerechoLado1HaciaArriba(ficha);
                              break;
                  }
            }
            ...
            if (ficha.getLado2() == extremoDerecha) {
                  switch (direccion) {
                        case "Derecha":
                              colocarFichaExtremoDerechoLado2HaciaDerecha(ficha);
                              break;
                        case "Abajo":
                              colocarFichaExtremoDerechoLado2HaciaAbajo(ficha);
                              break;
                        case "Izquierda":
                              colocarFichaExtremoDerechoLado2HaciaIzquierda(ficha);
                              break;
                        case "Arriba":
                              colocarFichaExtremoDerechoLado2HaciaArriba(ficha);
                              break;
                  }
            }
